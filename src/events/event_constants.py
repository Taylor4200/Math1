...
class EventConstants(Enum):
    ...
    # Sticky wilds events
    STICKY_WILDS_UPDATE = "stickyWildsUpdate"
    
    # Freedom Boost events
    FREEDOM_BOOST_ACTIVATED = "freedomBoostActivated"
    FREEDOM_BOOST_SPINS_REMAINING = "freedomBoostSpinsRemaining"