...
class GameConfig(Config):
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "0_0_lines_v3"  # "0_0_lines_v3"
        ...
        self.padding_symbol_values = {"W": {"multiplier": {
            2: 100, 3: 80, 5: 60, 10: 40, 20: 20, 50: 10, 100: 5, 200: 0.5, 500: 0.1}}}
                ...
                distributions=[
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "scatter_triggers": {3: 60, 4: 7},  # 3 scatters -> 10 spins, 4 scatters -> 12 spins (~1 in 900 spins)
                                "mult_values": {
                                self.basegame_type: {1: 20, 2: 60, 3: 80, 5: 50, 10: 30, 20: 20, 50: 10, 100: 5, 200: 0.5, 500: 0.1},
                                self.freegame_type: {2: 40, 3: 60, 5: 40, 10: 30, 20: 25, 50: 15, 100: 10, 200: 1, 500: 0.2},
                            },
                            "force_wincap": False,
                            "force_freegame": True,
                        },
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "scatter_triggers": {3: 0, 4: 25},  # Only 4 scatters -> 12 spins
                            "mult_values": {
                                self.basegame_type: {1: 1},
                                self.freegame_type: {20: 25, 50: 30, 100: 25, 200: 15, 500: 5},
                            },
                            "force_wincap": False,
                            "force_freegame": True,
                        },
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "mult_values": {
                                self.basegame_type: {1: 2, 2: 65, 3: 28, 5: 4, 10: 1, 20: 0.8, 50: 0.15, 100: 0.05, 200: 0.005, 500: 0.001},
                                self.freegame_type: {1: 12, 2: 58, 3: 25, 5: 22, 10: 15, 20: 10, 50: 4, 100: 3, 200: 0.3, 500: 0.1},
                            },
                            "force_wincap": False,
                ...
                distributions=[
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "mult_values": {
                                self.basegame_type: {1: 1},
                                self.freegame_type: {2: 140, 3: 160, 5: 140, 10: 120, 20: 100, 50: 50, 100: 40, 200: 2, 500: 0.5},
                            },
                            "force_wincap": False,
                            "force_freegame": True,
                        },
                ...
                distributions=[
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "mult_values": {
                                self.basegame_type: {1: 1},
                                self.freegame_type: {20: 140, 50: 120, 100: 100, 200: 60, 500: 40},
                            },
                            "force_wincap": False,
                            "force_freegame": True,
                        },
                ...
                distributions=[
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "scatter_triggers": {3: 180, 4: 21},  # Exactly 3x enhancement: 3 scatters = 10 spins, 4 scatters = 12 spins (~1 in 300 spins)
                            "mult_values": {
                                self.basegame_type: {1: 20, 2: 60, 3: 80, 5: 50, 10: 30, 20: 20, 50: 10, 100: 5, 200: 0.5, 500: 0.1},
                                self.freegame_type: {2: 40, 3: 60, 5: 40, 10: 30, 20: 25, 50: 15, 100: 10, 200: 1, 500: 0.2},
                            },
                    ...
                    Distribution(
                        ...
                        conditions={
                            "reel_weights": {self.basegame_type: {"BR0": 1}},
                            "mult_values": {
                                self.basegame_type: {1: 2, 2: 10, 3: 15, 5: 30, 10: 25, 20: 15, 50: 3, 200: 0.1, 500: 0.02},  # Full range favoring larger multipliers
                                self.freegame_type: {1: 2, 2: 10, 3: 15, 5: 30, 10: 25, 20: 15, 50: 3, 200: 0.1, 500: 0.02},  # Full range favoring larger multipliers
                            },
                            "force_wincap": False,
                            "force_freegame": False,
                        },
