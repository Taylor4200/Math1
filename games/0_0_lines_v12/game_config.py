    ...
    def __init__(self):
        ...
        self.bet_modes = [
            ...
            BetMode(
                ...
                distributions=[
                    Distribution(
                        criteria="1000x_multiplier_feature",
                        quota=1.0,  # 100% - always trigger 1000x multiplier feature
                        conditions={
                            "reel_weights": {
                                self.basegame_type: {"BR0": 1},
                                self.freegame_type: {"FR0": 1},
                            ...
                            "force_min_multiplier_value": 1000,  # Guarantee at least 1 multiplier is 1000x
                            "force_wincap": False,
                            "force_freegame": False,
                        },
                    ),
