# Lines Games V12 - STICKY WILDS (5x5 Grid)

This is a 5x5 grid version of the lines game with STICKY WILDS functionality and 13 paylines.
...
- The X2 modifier symbol can double existing sticky wild multipliers
- Sticky wilds are cleared when the free game ends
- **BALANCED**: Wilds only pay on 5-of-a-kind (50x) to prevent overpowered wins
- **CONSERVATIVE PAYTABLE**: Reduced all payouts by ~60-70% to balance with sticky wilds
- **HIERARCHY MAINTAINED**: H symbols still pay 3-5x more than L symbols
