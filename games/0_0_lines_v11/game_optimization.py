        ...
        self.game_config.opt_params = {
            ...
            "Bonus": {
                ...
                "parameters": ConstructParameters(
                    ...
                    min_m2m=4,
                    max_m2m=8,
                    pmb_rtp=0.955,  # Updated to match target RTP of 95.5%
                    sim_trials=5000,
                    test_spins=[10, 20, 50],
            ...
            "Super Bonus": {
                ...
                "parameters": ConstructParameters(
                    ...
                    min_m2m=4,
                    max_m2m=8,
                    pmb_rtp=0.953,  # Updated to match target RTP of 95.3%
                    sim_trials=5000,
                    test_spins=[10, 20, 50],
                    test_weights=[0.6, 0.2, 0.2],
                    score_type="rtp",
            ...
            "Feature Spin": {
                "conditions": {
                    "multiplier_feature": ConstructConditions(rtp=0.955, hr="x").return_dict(),  # 95.50% - matches Bonus Booster and Bonus
                },
            ...
            "Super Feature Spin": {
                "conditions": {
                    "500x_multiplier_feature": ConstructConditions(rtp=0.955, hr="x").return_dict(),  # 95.50% - matches Bonus Booster and Bonus
                },
                "scaling": ConstructScaling([]).return_dict(),
                "parameters": ConstructParameters(
                    num_show=2000,
