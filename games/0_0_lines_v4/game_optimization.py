        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    "freegame": ConstructConditions(
                        rtp=0.35, hr=120, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
            ...
            "bonus_booster": {
                "conditions": {
                    ...
                    "basegame_boosted": ConstructConditions(hr=4.5, rtp=0.635).return_dict(),  # 63.5% from basegame (total = 1.0 + 30 + 63.5 = 94.5)
                },
                "scaling": ConstructScaling([
                    {
            ...
            "bonus": {
                "conditions": {
                    "wincap": ConstructConditions(rtp=0.01, av_win=5000, search_conditions=5000).return_dict(),
                    "freegame": ConstructConditions(rtp=0.932, hr="x").return_dict(),
                },
                "scaling": ConstructScaling(
                    [
                        {
